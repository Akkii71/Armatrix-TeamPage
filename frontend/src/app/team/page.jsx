...
return ( <div className="relative min-h-screen bg-[#080C16] text-white overflow-x-hidden font-sans">
    ...
    >
      {teamData.map((member) => (
        <motion.div
          ...
          className="cursor-pointer group relative bg-[#080C16]/80 border border-white/10 rounded-2xl p-12 backdrop-blur-md overflow-hidden hover:bg-white/[0.08] hover:border-white/20 transition-all duration-300 shadow-[0_0_30px_rgba(0,0,0,0.5)] flex flex-col h-full pointer-events-auto"
        >
    ...
    {selectedMember && (
      ...
      >
        ...
        <motion.div
          ...
          className="relative bg-[#080C16] border border-white/10 rounded-3xl p-10 max-w-xl w-full shadow-[0_0_80px_rgba(0,255,136,0.2)]"
        >
